...
LETTERS = {
    ...
    # Ukrainian — Cyrillic alphabet, kid-friendly words
    "uk": {
        "а": {"letter": "А", "word": "Авокадо",  "desc": "avocado, dark green oval fruit cut in half showing pit"},
        "б": {"letter": "Б", "word": "Банан",    "desc": "banana, yellow curved tropical fruit"},
        "в": {"letter": "В", "word": "Вишня",    "desc": "sour cherry, two red cherries on a stem with green leaf"},
        "г": {"letter": "Г", "word": "Гарбуз",   "desc": "pumpkin, large round orange vegetable"},
        "ґ": {"letter": "Ґ", "word": "Ґудзик",   "desc": "button, single colorful round button on white"},
        "д": {"letter": "Д", "word": "Диня",     "desc": "honeydew melon, oval pale green melon"},
        "е": {"letter": "Е", "word": "Еклер",    "desc": "eclair, chocolate-glazed pastry on a plate"},
        "ж": {"letter": "Ж", "word": "Жолудь",   "desc": "acorn, single brown acorn with cap"},
        "з": {"letter": "З", "word": "Зелень",   "desc": "fresh herbs, dill and parsley bunch"},
        "и": {"letter": "И", "word": "Ириска",   "desc": "toffee candy, golden-brown wrapped toffee"},
        "і": {"letter": "І", "word": "Інжир",    "desc": "fig, ripe purple fig cut in half showing red inside"},
        "к": {"letter": "К", "word": "Кавун",    "desc": "watermelon, big round green striped fruit with red inside"},
        "л": {"letter": "Л", "word": "Лимон",    "desc": "lemon, bright yellow oval citrus fruit"},
        "м": {"letter": "М", "word": "Морква",   "desc": "carrot, long orange root vegetable"},
        "н": {"letter": "Н", "word": "Ніж",      "desc": "kid-safe knife, plastic toy knife"},
        "о": {"letter": "О", "word": "Огірок",   "desc": "cucumber, long green vegetable"},
        "п": {"letter": "П", "word": "Полуниця", "desc": "strawberry, red heart-shaped berry with seeds"},
        "р": {"letter": "Р", "word": "Редиска",  "desc": "radish, small round red root vegetable with white inside"},
        "с": {"letter": "С", "word": "Слива",    "desc": "plum, small oval purple-blue fruit"},
        "т": {"letter": "Т", "word": "Томат",    "desc": "tomato, round red shiny vegetable"},
        "у": {"letter": "У", "word": "Урюк",     "desc": "dried apricot, orange-brown dried apricot"},
        "ф": {"letter": "Ф", "word": "Фініки",   "desc": "date fruit, small brown oval dried fruit"},
        "х": {"letter": "Х", "word": "Хліб",     "desc": "bread, golden round loaf of bread"},
        "ц": {"letter": "Ц", "word": "Цибуля",   "desc": "onion, round papery brown onion"},
        "ч": {"letter": "Ч", "word": "Часник",   "desc": "garlic, single white garlic bulb"},
        "ш": {"letter": "Ш", "word": "Шоколад",  "desc": "chocolate bar, dark chocolate bar broken in pieces"},
        "я": {"letter": "Я", "word": "Яблуко",   "desc": "apple, round red and green fruit"},
    },
}
